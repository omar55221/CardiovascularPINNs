...
if __name__=="__main__":
	...
	parser.add_argument('-CPUFlag', '--CPUFlag', type=int, required=False,default=0, dest="CPUFlag",help="Flag to use CPU rather than GPU. Default is 0.")
	...
	parser.add_argument('-Omega0', '-Omega0', type=int, required=False, default=25, dest="Omega0", help="Only specified for the sinus activation and sinusResNet model. This parameter assigns the frequency for the first layer to improve performance. Default is 25.")
